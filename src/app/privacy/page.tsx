    ...
    <div className="container mx-auto py-12 max-w-4xl">
      <Card>
        ...
        <CardContent className="prose prose-invert max-w-none space-y-4">
            <p>
                Welcome to AutoFind. We are committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our application.
            </p>
